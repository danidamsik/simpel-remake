<div x-show="activeTab === 'user'" x-transition:enter="transition ease-out duration-300"
    ...
    <x-global.confirm-modal title="Konfirmasi Hapus Bendahara"
        message="Apakah Anda yakin ingin menghapus akun bendahara ini? Tindakan ini tidak dapat dibatalkan."
