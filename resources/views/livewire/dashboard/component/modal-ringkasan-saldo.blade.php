<div x-show="isOpen" x-cloak 
    ...
    <div 
        ...
        <!-- Body -->
        <div class="px-6 py-4  max-h-[70vh] overflow-y-auto scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-gray-100 dark:scrollbar-track-gray-800">
            ...
            <template x-if="activities.length === 0">
                <div class="text-center py-12">
                    ...
                    <h3 class="text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">Tidak ada kegiatan</h3>
                    <p class="text-sm text-gray-500 dark:text-gray-400">Belum ada kegiatan yang tercatat untuk lembaga ini</p>
                </div>
            </template>
                        ...
                        <tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-800">
                            <template x-for="(activity, index) in activities" :key="index">
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                                    ...
                                    <td class="px-4 py-3">
                                        <div class="text-sm">
                                            <div class="text-gray-900 dark:text-white" x-text="formatDate(activity.start_date)"></div>
                                        </div>
                                    </td>

                                    <td class="px-4 py-3">
                                        <div class="text-sm">
                                            <div class="text-gray-900 dark:text-white" x-text="formatDate(activity.end_date)"></div>
                                        </div>
                                    </td>

                                    <td class="px-4 py-3">
                                        <span class="text-sm text-gray-700 dark:text-gray-300" x-text="activity.location || '-'"></span>
                                    </td>

                                    <td class="px-4 py-3">
                                        <span class="text-sm font-medium text-red-600 dark:text-red-400">
                                            Rp <span x-text="new Intl.NumberFormat('id-ID').format(activity.funds_used)"></span>
                                        </span>
                                    </td>
                                    ...
                                    <td class="px-4 py-3">
                                        ...
                                        <template x-if="activity.lpj_status === 'Belum Disetor'">
                                            <span class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-400">
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('modalData', () => ({
            ...
            openModal(activitiesData, organizationName) {
