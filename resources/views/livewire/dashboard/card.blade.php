 <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-8">
     <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
         ...
         <div
             class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4 hover:shadow-md hover:-translate-y-1 transition-all duration-300">
             <div class="flex items-center space-x-3">
                 <div class="p-2.5 bg-gradient-to-br from-indigo-500 to-indigo-600 rounded-lg">
                     <i class="fas fa-chart-pie text-white text-lg"></i>
                 </div>
                 <div>
                     <p class="text-gray-600 dark:text-gray-400 text-xs font-medium">Total</p>
                     <h2 class="text-2xl font-bold text-gray-900 dark:text-white">53</h2>
                 </div>
             </div>
         </div>
