            ...
            <div class="flex items-center justify-between sm:justify-start space-x-3 sm:space-x-4">
                ...
                <div x-data="{ 
                    ...
                    <button @click="toggle()"
                        ...
                        <!-- Sun Icon (Light Mode) -->
                        <span
                            class="absolute left-1.5 top-1/2 -translate-y-1/2 text-yellow-300 transition-opacity duration-300"
                            :class="darkMode ? 'opacity-50' : 'opacity-100'">
                            <i class="fas fa-sun text-xs sm:text-sm"></i>
                        </span>
                        <!-- Moon Icon (Dark Mode) -->
                        <span
                            class="absolute right-1.5 top-1/2 -translate-y-1/2 text-white transition-opacity duration-300"
                ...
                <!-- User Profile Avatar -->
                <div
                    class="hidden sm:flex items-center space-x-3 pl-3 sm:pl-4 border-l border-gray-200 dark:border-gray-700">
                    <div class="relative">
                        <div
